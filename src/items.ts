...
export const items: Item[] = [
  ...
  },
  {
    ...
    tags: ['note-taking', 'zettelkasten', 'data-cloud', 'collab'],
  },
  {
    name: 'Mem',
    ...
    tags: ['note-taking', 'data-cloud', 'collab', 'free',],
  },
  {
    name: 'Reflect',
    ...
    tags: ['zettelkasten', 'note-taking', 'outliner', 'data-cloud'],
  },
  {
    name: 'Scrintal',
    ...
    tags: ['whitedoard', 'note-taking', 'zettelkasten', 'data-cloud', 'beta'],
  },
  {
    name: 'Trello',
